...
abstract: |
  Correct calculations with incorrect interpretation can be just as dangerous as wrong 
  numbers. This chapter develops the logic of statistical inference — confidence intervals, 
  hypothesis testing, and the proper meaning of p-values — through BorderMed 
  Pharmaceuticals' Phase II clinical trial, where a $500 million Phase III commitment 
  hangs on whether the analysis team understands what their results actually say. Students 
  learn to quantify uncertainty honestly, avoid common inference errors, and communicate 
  statistical findings with appropriate precision.
---
